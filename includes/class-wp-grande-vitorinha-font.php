...
class WP_Grande_Vitorinha_Font {
	 ...
	 *
	 * - WP_Grande_Vitorinha_Font_Loader. Orchestrates the hooks of the plugin.
	 * - WP_Grande_Vitorinha_Font_i18n. Defines internationalization functionality.
	 * - WP_Grande_Vitorinha_Font_Admin. Defines all hooks for the admin area.
	 * - WP_Grande_Vitorinha_Font_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Grande_Vitorinha_Font_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Grande_Vitorinha_Font_Loader    Orchestrates the hooks of the plugin.
	 */
